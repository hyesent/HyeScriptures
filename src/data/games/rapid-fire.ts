...
export interface RapidFireQuestion {
  ...
  isTrue: boolean;
  explanation: string;
  category?: 'old-testament' | 'new-testament' | 'characters' | 'places' | 'books' | 'jesus' | 'apostles' | 'miracles' | 'prophets' | 'law' | 'history' | 'mixed' | 'kings' | 'judges' | 'women' | 'parables' | 'epistles' | 'psalms' | 'proverbs' | 'angels' | 'exodus' | 'creation' | 'covenants' | 'feasts' | 'worship' | 'prayer' | 'end-times' | 'early-church' | 'pentecost' | 'jesus-teachings' | 'disciples' | 'praise' | 'forgiveness' | 'grace' | 'faith' | 'hope' | 'love' | 'joy' | 'peace' | 'patience' | 'kindness' | 'goodness' | 'faithfulness' | 'gentleness' | 'self-control';
...
export const rapidFireQuestions: RapidFireQuestion[] = [
  ...
  { id: 'r4', statement: 'The Garden of Eden was located in Egypt', isTrue: false, explanation: 'The Garden of Eden was in the east (Genesis 2:8), not Egypt', category: 'creation', difficulty: 'medium' },
  ...
  { id: 'r11', statement: 'Noah sent out a raven to find dry land', isTrue: true, explanation: 'Noah sent out a raven first, then a dove', category: 'creation', difficulty: 'medium' },
  ...
  { id: 'r16', statement: 'Eve was created before Adam', isTrue: false, explanation: 'Adam was created first, then Eve from his rib', category: 'creation', difficulty: 'easy' },
  ...
  { id: 'r20', statement: 'Noah was a fisherman before the flood', isTrue: false, explanation: 'Noah was a farmer and preacher of righteousness, not a fisherman', category: 'creation', difficulty: 'medium' },
  ...
  { id: 'r23', statement: 'Sarah was Abraham\'s sister', isTrue: false, explanation: 'Sarah was Abraham\'s wife, and also his half-sister', category: 'covenants', difficulty: 'medium' },
  ...
  { id: 'r35', statement: 'Israel had 10 sons', isTrue: false, explanation: 'Jacob/Israel had 12 sons who became the 12 tribes', category: 'covenants', difficulty: 'easy' },
  ...
  { id: 'r41', statement: 'The covenant was sealed with baptism', isTrue: false, explanation: 'Circumcision was the sign of the covenant, not baptism', category: 'covenants', difficulty: 'medium' },
  ...
  { id: 'r51', statement: 'God told Moses His name was "El Shaddai"', isTrue: false, explanation: 'God revealed His name as "I AM WHO I AM"', category: 'exodus', difficulty: 'medium' },
  ...
  { id: 'r57', statement: 'The Israelites were in slavery in Egypt for 100 years', isTrue: false, explanation: 'The Israelites were slaves in Egypt for about 400 years', category: 'exodus', difficulty: 'hard' },
  ...
  { id: 'r64', statement: 'The Ten Commandments were written on papyrus', isTrue: false, explanation: 'The commandments were written on two stone tablets', category: 'law', difficulty: 'easy' },
  ...
  { id: 'r71', statement: 'The Israelites wandered for 20 years', isTrue: false, explanation: 'They wandered for 40 years because of their unbelief', category: 'exodus', difficulty: 'easy' },
  ...
  { id: 'r75', statement: 'Moses was the most proud man on earth', isTrue: false, explanation: 'The Bible says Moses was very humble (Numbers 12:3)', category: 'exodus', difficulty: 'hard' },
  ...
  { id: 'r84', statement: 'Samson killed 100 Philistines with a jawbone', isTrue: false, explanation: 'Samson killed 1,000 Philistines with the jawbone of a donkey', category: 'judges', difficulty: 'medium' },
  ...
  { id: 'r86', statement: 'Ruth was an Israelite', isTrue: false, explanation: 'Ruth was a Moabite who followed Naomi', category: 'judges', difficulty: 'easy' },
  ...
  { id: 'r90', statement: 'Ruth is not mentioned in the genealogy of Jesus', isTrue: false, explanation: 'Ruth is included in the genealogy of Jesus in Matthew', category: 'judges', difficulty: 'hard' },
  ...
  { id: 'r98', statement: 'David was the first king of Israel', isTrue: false, explanation: 'David was the second king of Israel, after Saul', category: 'kings', difficulty: 'easy' },
  ...
  { id: 'r109', statement: 'Solomon had 100 wives', isTrue: false, explanation: 'Solomon had 700 wives and 300 concubines', category: 'kings', difficulty: 'medium' },
  ...
  { id: 'r112', statement: 'The northern kingdom was called Judah', isTrue: false, explanation: 'The northern kingdom was called Israel, the southern was Judah', category: 'kings', difficulty: 'easy' },
  ...
  { id: 'r117', statement: 'The northern kingdom was destroyed by Babylon', isTrue: false, explanation: 'The northern kingdom was destroyed by Assyria in 722 BC', category: 'kings', difficulty: 'hard' },
  ...
  { id: 'r120', statement: 'Jonathan was David\'s enemy', isTrue: false, explanation: 'Jonathan was David\'s best friend, not his enemy', category: 'kings', difficulty: 'easy' },
  ...
  { id: 'r124', statement: 'Elisha performed fewer miracles than Elijah', isTrue: false, explanation: 'Elisha performed twice as many miracles as Elijah', category: 'prophets', difficulty: 'hard' },
  ...
  { id: 'r130', statement: 'Ezekiel was a farmer before becoming a prophet', isTrue: false, explanation: 'Ezekiel was from a priestly family, not a farmer', category: 'prophets', difficulty: 'hard' },
  ...
  { id: 'r136', statement: 'The people of Nineveh rejected Jonah\'s message', isTrue: false, explanation: 'The Ninevites repented after Jonah\'s message', category: 'prophets', difficulty: 'easy' },
  ...
  { id: 'r139', statement: 'Malachi was the first prophet of the Old Testament', isTrue: false, explanation: 'Malachi was the final Old Testament prophet, not the first', category: 'prophets', difficulty: 'medium' },
  ...
  { id: 'r149', statement: 'The Psalms were written mostly by Solomon', isTrue: false, explanation: 'David wrote about 75 of the Psalms, not Solomon', category: 'psalms', difficulty: 'easy' },
  ...
  { id: 'r153', statement: 'Psalm 100 is a lament', isTrue: false, explanation: 'Psalm 100 is a psalm of praise, not a lament', category: 'psalms', difficulty: 'medium' },
  ...
  { id: 'r159', statement: 'Proverbs was written to give knowledge only', isTrue: false, explanation: 'Proverbs gives wisdom and instruction, not just knowledge', category: 'proverbs', difficulty: 'easy' },
  ...
  { id: 'r165', statement: 'Ecclesiastes was written by David', isTrue: false, explanation: 'Solomon wrote Ecclesiastes, not David', category: 'proverbs', difficulty: 'hard' },
  ...
  { id: 'r169', statement: 'Rebekah was Isaac\'s mother', isTrue: false, explanation: 'Rebekah was Isaac\'s wife, not his mother', category: 'women', difficulty: 'easy' },
  ...
  { id: 'r173', statement: 'Miriam was a queen', isTrue: false, explanation: 'Miriam was a prophetess, not a queen', category: 'women', difficulty: 'medium' },
  ...
  { id: 'r188', statement: 'Rahab was a queen', isTrue: false, explanation: 'Rahab was a prostitute who helped the spies', category: 'women', difficulty: 'easy' },
  ...
  { id: 'r202', statement: 'Jesus turned water into wine at a wedding in Cana', isTrue: true, explanation: 'This was Jesus\' first miracle', category: 'miracles', difficulty: 'easy' },
  ...
  { id: 'r214', statement: 'The apostles performed no miracles after Jesus left', isTrue: false, explanation: 'The apostles performed many miracles after Pentecost', category: 'miracles', difficulty: 'easy' },
  ...
  { id: 'r221', statement: 'The Parable of the Good Samaritan was told to a priest', isTrue: false, explanation: 'A lawyer asked Jesus about eternal life', category: 'parables', difficulty: 'hard' },
  ...
  { id: 'r225', statement: 'The Parable of the Persistent Widow is about anger', isTrue: false, explanation: 'This parable is about prayer and persistence', category: 'parables', difficulty: 'hard' },
  ...
  { id: 'r230', statement: 'The Parable of the Pearl of Great Price is about wealth', isTrue: false, explanation: 'This is about the kingdom of heaven, not earthly wealth', category: 'parables', difficulty: 'medium' },
  ...
  { id: 'r234', statement: 'The disciples never asked Jesus to explain the parables', isTrue: false, explanation: 'The disciples often asked for explanations', category: 'parables', difficulty: 'medium' },
  ...
  { id: 'r260', statement: 'Jesus never prayed', isTrue: false, explanation: 'Jesus frequently prayed to the Father', category: 'jesus', difficulty: 'easy' },
  ...
  { id: 'r279', statement: 'Jude is the first of the general epistles', isTrue: false, explanation: 'Jude is one of the last general epistles', category: 'epistles', difficulty: 'hard' },
  ...
  { id: 'r304', statement: 'The book of Proverbs was written by David', isTrue: false, explanation: 'Solomon wrote the book of Proverbs, not David', category: 'books', difficulty: 'easy' },
  ...
  { id: 'r330', statement: 'The Bible contains only history', isTrue: false, explanation: 'The Bible has historical and poetic books', category: 'mixed', difficulty: 'easy' },
  ...
  // ================================================================
  // SECTION 16: EARLY CHURCH & PENTECOST (20 NEW questions)
  // ================================================================
  { id: 'r401', statement: 'The Holy Spirit came at Pentecost', isTrue: true, explanation: 'Acts 2:1-4 describes the coming of the Holy Spirit', category: 'pentecost', difficulty: 'easy' },
  { id: 'r402', statement: 'Pentecost was 50 days after Passover', isTrue: true, explanation: 'Pentecost means "fiftieth" in Greek', category: 'pentecost', difficulty: 'medium' },
  { id: 'r403', statement: 'The disciples spoke in tongues at Pentecost', isTrue: true, explanation: 'They spoke in other languages as the Spirit gave utterance', category: 'pentecost', difficulty: 'easy' },
  { id: 'r404', statement: '5,000 people were saved at Pentecost', isTrue: false, explanation: 'About 3,000 were added to the church that day', category: 'pentecost', difficulty: 'easy' },
  { id: 'r405', statement: 'Peter preached the sermon at Pentecost', isTrue: true, explanation: 'Peter preached the first gospel sermon', category: 'pentecost', difficulty: 'easy' },
  { id: 'r406', statement: 'The early church shared everything in common', isTrue: true, explanation: 'Acts 4:32 describes the community of believers', category: 'early-church', difficulty: 'easy' },
  { id: 'r407', statement: 'Stephen was the first Christian martyr', isTrue: true, explanation: 'Stephen was stoned for his faith', category: 'early-church', difficulty: 'easy' },
  { id: 'r408', statement: 'Philip baptized the Ethiopian eunuch', isTrue: true, explanation: 'Philip explained the Scriptures and baptized him', category: 'early-church', difficulty: 'medium' },
  { id: 'r409', statement: 'Paul was always a Christian', isTrue: false, explanation: 'Paul persecuted the church before his conversion', category: 'early-church', difficulty: 'easy' },
  { id: 'r410', statement: 'Peter was imprisoned and miraculously released', isTrue: true, explanation: 'An angel freed Peter from prison', category: 'early-church', difficulty: 'medium' },
  { id: 'r411', statement: 'The church in Antioch was the first to be called "Christians"', isTrue: true, explanation: 'Acts 11:26 says they were called Christians first in Antioch', category: 'early-church', difficulty: 'hard' },
  { id: 'r412', statement: 'Barnabas was called the "Son of Thunder"', isTrue: false, explanation: 'Barnabas was called "Son of Encouragement", James and John were "Sons of Thunder"', category: 'early-church', difficulty: 'hard' },
  { id: 'r413', statement: 'The Jerusalem Council addressed whether Gentiles needed to follow the Law', isTrue: true, explanation: 'Acts 15 records the Jerusalem Council', category: 'early-church', difficulty: 'medium' },
  { id: 'r414', statement: 'Paul wrote letters to the churches', isTrue: true, explanation: 'Paul wrote many epistles to churches', category: 'epistles', difficulty: 'easy' },
  { id: 'r415', statement: 'The early church grew rapidly despite persecution', isTrue: true, explanation: 'The church multiplied even under persecution', category: 'early-church', difficulty: 'easy' },
  { id: 'r416', statement: 'Aquila and Priscilla were tentmakers like Paul', isTrue: true, explanation: 'Paul worked with Aquila and Priscilla making tents', category: 'early-church', difficulty: 'hard' },
  { id: 'r417', statement: 'Apollos was from Athens', isTrue: false, explanation: 'Apollos was from Alexandria, not Athens', category: 'early-church', difficulty: 'hard' },
  { id: 'r418', statement: 'The church prayed for Peter when he was in prison', isTrue: true, explanation: 'The church prayed earnestly for Peter', category: 'early-church', difficulty: 'easy' },
  { id: 'r419', statement: 'Tabitha (Dorcas) was raised from the dead by Peter', isTrue: true, explanation: 'Peter raised Tabitha back to life', category: 'early-church', difficulty: 'medium' },
  { id: 'r420', statement: 'The early church met in the Temple only', isTrue: false, explanation: 'The church met in homes as well as the Temple', category: 'early-church', difficulty: 'easy' },

  // ================================================================
  // SECTION 17: JESUS' TEACHINGS (20 NEW questions)
  // ================================================================
  { id: 'r421', statement: 'Jesus taught the Beatitudes', isTrue: true, explanation: 'The Beatitudes are in Matthew 5:3-12', category: 'jesus-teachings', difficulty: 'easy' },
  { id: 'r422', statement: 'The Beatitudes begin with "Blessed are the poor in spirit"', isTrue: true, explanation: 'Matthew 5:3 is the first Beatitude', category: 'jesus-teachings', difficulty: 'medium' },
  { id: 'r423', statement: 'Jesus taught the Lord\'s Prayer', isTrue: true, explanation: 'Jesus gave the model prayer in Matthew 6:9-13', category: 'prayer', difficulty: 'easy' },
  { id: 'r424', statement: 'The Lord\'s Prayer begins with "Our Father in heaven"', isTrue: true, explanation: 'Jesus taught us to pray to our Father', category: 'prayer', difficulty: 'easy' },
  { id: 'r425', statement: 'Jesus said to hate your enemies', isTrue: false, explanation: 'Jesus taught to love and pray for enemies', category: 'love', difficulty: 'easy' },
  { id: 'r426', statement: 'Jesus said to turn the other cheek', isTrue: true, explanation: 'This is Jesus\' teaching on non-retaliation', category: 'jesus-teachings', difficulty: 'easy' },
  { id: 'r427', statement: 'Jesus taught about the narrow and wide gates', isTrue: true, explanation: 'Matthew 7:13-14 describes the narrow gate', category: 'jesus-teachings', difficulty: 'medium' },
  { id: 'r428', statement: 'Jesus said "Ask, and it will be given to you"', isTrue: true, explanation: 'Matthew 7:7 is about prayer', category: 'prayer', difficulty: 'easy' },
  { id: 'r429', statement: 'Jesus taught about the wise and foolish builders', isTrue: true, explanation: 'The parable is in Matthew 7:24-27', category: 'parables', difficulty: 'medium' },
  { id: 'r430', statement: 'Jesus said to render to Caesar what is Caesar\'s', isTrue: true, explanation: 'Jesus taught about paying taxes', category: 'jesus-teachings', difficulty: 'easy' },
  { id: 'r431', statement: 'Jesus said the greatest commandment is to love yourself', isTrue: false, explanation: 'Jesus said the greatest commandment is to love God with all your heart', category: 'love', difficulty: 'easy' },
  { id: 'r432', statement: 'The second greatest commandment is to love your neighbor', isTrue: true, explanation: 'Jesus said love your neighbor as yourself', category: 'love', difficulty: 'easy' },
  { id: 'r433', statement: 'Jesus taught about the hidden treasure in a field', isTrue: true, explanation: 'This is a parable about the kingdom of heaven', category: 'parables', difficulty: 'medium' },
  { id: 'r434', statement: 'Jesus said "I am the door of the sheep"', isTrue: true, explanation: 'John 10:7-9 describes Jesus as the door', category: 'jesus', difficulty: 'medium' },
  { id: 'r435', statement: 'Jesus said "My sheep hear My voice"', isTrue: true, explanation: 'Jesus said His sheep know His voice', category: 'jesus', difficulty: 'easy' },
  { id: 'r436', statement: 'Jesus taught about the unforgiving servant', isTrue: true, explanation: 'This is a parable about forgiveness', category: 'forgiveness', difficulty: 'medium' },
  { id: 'r437', statement: 'Jesus said "You shall know the truth, and the truth shall make you free"', isTrue: true, explanation: 'John 8:32 is about truth and freedom', category: 'jesus-teachings', difficulty: 'easy' },
  { id: 'r438', statement: 'Jesus taught about the Good Shepherd', isTrue: true, explanation: 'John 10 describes Jesus as the Good Shepherd', category: 'jesus', difficulty: 'easy' },
  { id: 'r439', statement: 'Jesus said "I have come to judge the world"', isTrue: false, explanation: 'Jesus said "I have come to seek and to save the lost"', category: 'jesus', difficulty: 'easy' },
  { id: 'r440', statement: 'Jesus taught the parable of the persistent widow', isTrue: true, explanation: 'This parable is about prayer and persistence', category: 'prayer', difficulty: 'hard' },

  // ================================================================
  // SECTION 18: FRUIT OF THE SPIRIT (20 NEW questions)
  // ================================================================
  { id: 'r441', statement: 'Love is a fruit of the Spirit', isTrue: true, explanation: 'Galatians 5:22 lists love first among the fruit', category: 'love', difficulty: 'easy' },
  { id: 'r442', statement: 'Joy is a fruit of the Spirit', isTrue: true, explanation: 'Joy is listed in Galatians 5:22', category: 'joy', difficulty: 'easy' },
  { id: 'r443', statement: 'Peace is a fruit of the Spirit', isTrue: true, explanation: 'Peace is listed in Galatians 5:22', category: 'peace', difficulty: 'easy' },
  { id: 'r444', statement: 'Patience is a fruit of the Spirit', isTrue: true, explanation: 'Patience is listed in Galatians 5:22', category: 'patience', difficulty: 'easy' },
  { id: 'r445', statement: 'Kindness is a fruit of the Spirit', isTrue: true, explanation: 'Kindness is listed in Galatians 5:22', category: 'kindness', difficulty: 'easy' },
  { id: 'r446', statement: 'Goodness is a fruit of the Spirit', isTrue: true, explanation: 'Goodness is listed in Galatians 5:22', category: 'goodness', difficulty: 'easy' },
  { id: 'r447', statement: 'Faithfulness is a fruit of the Spirit', isTrue: true, explanation: 'Faithfulness is listed in Galatians 5:22', category: 'faithfulness', difficulty: 'easy' },
  { id: 'r448', statement: 'Gentleness is a fruit of the Spirit', isTrue: true, explanation: 'Gentleness is listed in Galatians 5:23', category: 'gentleness', difficulty: 'easy' },
  { id: 'r449', statement: 'Self-control is a fruit of the Spirit', isTrue: true, explanation: 'Self-control is listed in Galatians 5:23', category: 'self-control', difficulty: 'easy' },
  { id: 'r450', statement: 'The fruit of the Spirit is from Ephesians', isTrue: false, explanation: 'The fruit of the Spirit is from Galatians 5, not Ephesians', category: 'epistles', difficulty: 'easy' },
  { id: 'r451', statement: 'The Spirit produces love in believers', isTrue: true, explanation: 'Love is the first evidence of the Spirit\'s work', category: 'love', difficulty: 'easy' },
  { id: 'r452', statement: 'Joy in the Spirit is not dependent on circumstances', isTrue: true, explanation: 'The Spirit gives joy regardless of situation', category: 'joy', difficulty: 'medium' },
  { id: 'r453', statement: 'Peace from the Spirit passes understanding', isTrue: true, explanation: 'Philippians 4:7 describes God\'s peace', category: 'peace', difficulty: 'medium' },
  { id: 'r454', statement: 'Patience is a sign of weakness', isTrue: false, explanation: 'Patience is a sign of the Spirit\'s work, not weakness', category: 'patience', difficulty: 'easy' },
  { id: 'r455', statement: 'Kindness should be shown to all people', isTrue: true, explanation: 'The Spirit produces kindness toward others', category: 'kindness', difficulty: 'easy' },
  { id: 'r456', statement: 'Goodness includes doing good to others', isTrue: true, explanation: 'Goodness is active and outward', category: 'goodness', difficulty: 'easy' },
  { id: 'r457', statement: 'Faithfulness is being trustworthy and loyal', isTrue: true, explanation: 'The Spirit produces faithfulness', category: 'faithfulness', difficulty: 'easy' },
  { id: 'r458', statement: 'Gentleness is strength under control', isTrue: true, explanation: 'The Spirit produces gentleness', category: 'gentleness', difficulty: 'medium' },
  { id: 'r459', statement: 'Self-control helps resist temptation', isTrue: true, explanation: 'The Spirit helps believers exercise self-control', category: 'self-control', difficulty: 'easy' },
  { id: 'r460', statement: 'The Spirit helps believers bear fruit', isTrue: true, explanation: 'The Spirit works in believers to produce fruit', category: 'mixed', difficulty: 'easy' },

  // ================================================================
  // SECTION 19: GRACE, FAITH, HOPE (20 NEW questions)
  // ================================================================
  { id: 'r461', statement: 'Grace is unmerited favor from God', isTrue: true, explanation: 'Grace is God\'s undeserved favor', category: 'grace', difficulty: 'easy' },
  { id: 'r462', statement: 'Faith is confidence in what we hope for', isTrue: true, explanation: 'Hebrews 11:1 defines faith', category: 'faith', difficulty: 'easy' },
  { id: 'r463', statement: 'Hope anchors the soul', isTrue: true, explanation: 'Hebrews 6:19 describes hope as an anchor', category: 'hope', difficulty: 'medium' },
  { id: 'r464', statement: 'Salvation is by grace through faith', isTrue: true, explanation: 'Ephesians 2:8-9 teaches salvation by grace', category: 'grace', difficulty: 'easy' },
  { id: 'r465', statement: 'Faith is a gift from God', isTrue: true, explanation: 'Faith is given by God', category: 'faith', difficulty: 'easy' },
  { id: 'r466', statement: 'Hope does not disappoint', isTrue: true, explanation: 'Romans 5:5 says hope does not disappoint', category: 'hope', difficulty: 'easy' },
  { id: 'r467', statement: 'Grace teaches us to say no to ungodliness', isTrue: true, explanation: 'Titus 2:11-12 describes grace teaching us', category: 'grace', difficulty: 'medium' },
  { id: 'r468', statement: 'Faith can move mountains', isTrue: true, explanation: 'Jesus said faith can move mountains', category: 'faith', difficulty: 'easy' },
  { id: 'r469', statement: 'Hope is a helmet for the mind', isTrue: true, explanation: '1 Thessalonians 5:8 describes hope as a helmet', category: 'hope', difficulty: 'medium' },
  { id: 'r470', statement: 'Grace is earned by good works', isTrue: false, explanation: 'Grace is unearned favor, not based on works', category: 'grace', difficulty: 'easy' },
  { id: 'r471', statement: 'Faith without works is dead', isTrue: true, explanation: 'James 2:17 says faith without works is dead', category: 'faith', difficulty: 'easy' },
  { id: 'r472', statement: 'Hope is essential for believers', isTrue: true, explanation: 'Hope sustains believers through trials', category: 'hope', difficulty: 'easy' },
  { id: 'r473', statement: 'Grace is sufficient for all needs', isTrue: true, explanation: '2 Corinthians 12:9 says God\'s grace is sufficient', category: 'grace', difficulty: 'easy' },
  { id: 'r474', statement: 'Faith comes by hearing the Word of God', isTrue: true, explanation: 'Romans 10:17 describes how faith comes', category: 'faith', difficulty: 'easy' },
  { id: 'r475', statement: 'Hope is only for this life', isTrue: false, explanation: 'Hope is for eternal life, not just this life', category: 'hope', difficulty: 'medium' },
  { id: 'r476', statement: 'Grace transforms the believer', isTrue: true, explanation: 'Grace changes how believers live', category: 'grace', difficulty: 'easy' },
  { id: 'r477', statement: 'Faith moves the heart of God', isTrue: true, explanation: 'Faith pleases God', category: 'faith', difficulty: 'easy' },
  { id: 'r478', statement: 'Hope is based on God\'s promises', isTrue: true, explanation: 'Hope is anchored in God\'s faithfulness', category: 'hope', difficulty: 'easy' },
  { id: 'r479', statement: 'Grace was only for Old Testament believers', isTrue: false, explanation: 'Grace is for all believers in all times', category: 'grace', difficulty: 'medium' },
  { id: 'r480', statement: 'Faith, hope, and love remain', isTrue: true, explanation: '1 Corinthians 13:13 says these three remain', category: 'love', difficulty: 'easy' },

  // ================================================================
  // SECTION 20: WORSHIP & PRAISE (20 NEW questions)
  // ================================================================
  { id: 'r481', statement: 'Worship is giving honor to God', isTrue: true, explanation: 'Worship is honoring and glorifying God', category: 'worship', difficulty: 'easy' },
  { id: 'r482', statement: 'The Psalms were used in worship', isTrue: true, explanation: 'The Psalms were sung in Temple worship', category: 'psalms', difficulty: 'easy' },
  { id: 'r483', statement: 'Praise is only with music', isTrue: false, explanation: 'Praise can be with words, music, and actions', category: 'praise', difficulty: 'easy' },
  { id: 'r484', statement: 'Angels worship God', isTrue: true, explanation: 'Angels worship and praise God in heaven', category: 'worship', difficulty: 'easy' },
  { id: 'r485', statement: 'The Tabernacle was a place of worship', isTrue: true, explanation: 'The Tabernacle was built for worship', category: 'worship', difficulty: 'easy' },
  { id: 'r486', statement: 'The Temple was a place of worship', isTrue: true, explanation: 'The Temple was the central place of worship', category: 'worship', difficulty: 'easy' },
  { id: 'r487', statement: 'Worship is only on Sundays', isTrue: false, explanation: 'Worship is a lifestyle, not just one day', category: 'worship', difficulty: 'easy' },
  { id: 'r488', statement: 'Praise is lifting up God\'s name', isTrue: true, explanation: 'Praise exalts and honors God', category: 'praise', difficulty: 'easy' },
  { id: 'r489', statement: 'The angels sang at Jesus\' birth', isTrue: true, explanation: 'Angels praised God at Jesus\' birth', category: 'worship', difficulty: 'easy' },
  { id: 'r490', statement: 'Worship requires special instruments', isTrue: false, explanation: 'Worship can be with or without instruments', category: 'worship', difficulty: 'medium' },
  { id: 'r491', statement: 'Praise is commanded in the Bible', isTrue: true, explanation: 'The Bible commands believers to praise God', category: 'praise', difficulty: 'easy' },
  { id: 'r492', statement: 'The Psalms contain many songs of praise', isTrue: true, explanation: 'The Psalms are full of praise', category: 'psalms', difficulty: 'easy' },
  { id: 'r493', statement: 'Worship should be reverent', isTrue: true, explanation: 'Worship should honor God with reverence', category: 'worship', difficulty: 'easy' },
  { id: 'r494', statement: 'Praise is only for good times', isTrue: false, explanation: 'Praise is for all times, even hard times', category: 'praise', difficulty: 'easy' },
  { id: 'r495', statement: 'The Ark of the Covenant was used in worship', isTrue: true, explanation: 'The Ark was central to Israel\'s worship', category: 'worship', difficulty: 'easy' },
  { id: 'r496', statement: 'Worship was central to Israel\'s life', isTrue: true, explanation: 'Worship was at the heart of Israel\'s identity', category: 'worship', difficulty: 'easy' },
  { id: 'r497', statement: 'Praise can be expressed with dancing', isTrue: true, explanation: 'David danced before the Lord in praise', category: 'praise', difficulty: 'easy' },
  { id: 'r498', statement: 'Worship is only for the Old Testament', isTrue: false, explanation: 'Worship is for all believers in all times', category: 'worship', difficulty: 'easy' },
  { id: 'r499', statement: 'The early church worshiped together', isTrue: true, explanation: 'The early church gathered for worship', category: 'early-church', difficulty: 'easy' },
  { id: 'r500', statement: 'Worship will continue in heaven', isTrue: true, explanation: 'Heaven is a place of eternal worship', category: 'worship', difficulty: 'easy' },

  // ================================================================
  // SECTION 21: FORGIVENESS & MERCY (20 NEW questions)
  // ================================================================
  { id: 'r501', statement: 'God is merciful and forgiving', isTrue: true, explanation: 'God\'s mercy and forgiveness are central to His character', category: 'forgiveness', difficulty: 'easy' },
  { id: 'r502', statement: 'Jesus taught to forgive seventy times seven', isTrue: true, explanation: 'Jesus said to forgive 70 times 7 times', category: 'forgiveness', difficulty: 'easy' },
  { id: 'r503', statement: 'Forgiveness is optional for believers', isTrue: false, explanation: 'Believers are commanded to forgive others', category: 'forgiveness', difficulty: 'easy' },
  { id: 'r504', statement: 'Mercy is not getting what we deserve', isTrue: true, explanation: 'Mercy is God not giving us the punishment we deserve', category: 'forgiveness', difficulty: 'medium' },
  { id: 'r505', statement: 'The Parable of the Unforgiving Servant teaches about forgiveness', isTrue: true, explanation: 'This parable shows the importance of forgiving others', category: 'forgiveness', difficulty: 'medium' },
  { id: 'r506', statement: 'God forgives all sins', isTrue: true, explanation: 'God forgives those who confess and repent', category: 'forgiveness', difficulty: 'easy' },
  { id: 'r507', statement: 'Forgiveness requires forgetting', isTrue: false, explanation: 'Forgiveness is about releasing the debt, not necessarily forgetting', category: 'forgiveness', difficulty: 'medium' },
  { id: 'r508', statement: 'Mercy triumphs over judgment', isTrue: true, explanation: 'James 2:13 says mercy triumphs over judgment', category: 'forgiveness', difficulty: 'medium' },
  { id: 'r509', statement: 'Jesus forgave those who crucified Him', isTrue: true, explanation: 'Jesus said "Father, forgive them" on the cross', category: 'forgiveness', difficulty: 'easy' },
  { id: 'r510', statement: 'Forgiveness is only for small sins', isTrue: false, explanation: 'Forgiveness is for all sins, no matter how great', category: 'forgiveness', difficulty: 'easy' },
  { id: 'r511', statement: 'God\'s mercy is new every morning', isTrue: true, explanation: 'Lamentations 3:22-23 says God\'s mercies are new every morning', category: 'forgiveness', difficulty: 'easy' },
  { id: 'r512', statement: 'Forgiveness brings freedom', isTrue: true, explanation: 'Forgiveness releases both the offender and the offended', category: 'forgiveness', difficulty: 'easy' },
  { id: 'r513', statement: 'Mercy is a fruit of the Spirit', isTrue: true, explanation: 'Mercy is an expression of the Spirit\'s work', category: 'forgiveness', difficulty: 'medium' },
  { id: 'r514', statement: 'Forgiveness is a choice', isTrue: true, explanation: 'Forgiveness is an act of the will, not just a feeling', category: 'forgiveness', difficulty: 'easy' },
  { id: 'r515', statement: 'God shows mercy to the humble', isTrue: true, explanation: 'God gives grace to the humble', category: 'forgiveness', difficulty: 'easy' },
  { id: 'r516', statement: 'Forgiveness requires repentance', isTrue: false, explanation: 'Forgiveness is offered freely, though repentance is important for restoration', category: 'forgiveness', difficulty: 'hard' },
  { id: 'r517', statement: 'The prodigal son experienced mercy', isTrue: true, explanation: 'The father showed mercy to his returning son', category: 'forgiveness', difficulty: 'easy' },
  { id: 'r518', statement: 'God is slow to anger and abounding in mercy', isTrue: true, explanation: 'God\'s character is merciful and patient', category: 'forgiveness', difficulty: 'easy' },
  { id: 'r519', statement: 'Forgiveness is a sign of weakness', isTrue: false, explanation: 'Forgiveness is a sign of strength, not weakness', category: 'forgiveness', difficulty: 'easy' },
  { id: 'r520', statement: 'Mercy is getting what we deserve', isTrue: false, explanation: 'Mercy is not getting what we deserve; grace is getting what we don\'t deserve', category: 'forgiveness', difficulty: 'medium' },
];
...
export const getCategories = (): { value: string; label: string; count: number }[] => {
  const categories = [
    ...
    'early-church', 'pentecost', 'jesus-teachings', 'disciples', 'praise', 
    'forgiveness', 'grace', 'faith', 'hope', 'love', 'joy', 'peace', 'patience', 
    'kindness', 'goodness', 'faithfulness', 'gentleness', 'self-control'
  ];
